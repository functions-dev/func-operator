...
var (
	...
	projectImage = "example.com/objectbucket-notifications-adapter:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting objectbucket-notifications-adapter integration test suite\n")
